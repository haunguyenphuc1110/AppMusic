...
public class DanhSachPlaylistAdapter extends RecyclerView.Adapter<DanhSachPlaylistAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view  = inflater.inflate(R.layout.row_danh_sach_playlist,viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        Picasso.with(context).load(playlist.getHinhPlaylist()).into(viewHolder.imgPlaylist);
    }
